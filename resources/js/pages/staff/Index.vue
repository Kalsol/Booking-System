    ...
    <div class="flex h-full flex-1 flex-col gap-4 overflow-x-auto rounded-xl p-4">
        <header class="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-10">
            ...
            <div class="flex items-center gap-3 w-full md:w-auto">
                ...
                <Button class="bg-[#ffd700] hover:bg-[#e6c200] text-black font-bold gap-2 whitespace-nowrap">
                    <UserPlus :size="18" />
                    Hire Staff
                </Button>
            </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            >
                <div 
                    class="absolute top-6 right-6 w-2.5 h-2.5 rounded-full"
                    :class="member.status === 'online' ? 'bg-green-500 shadow-[0_0_8px_rgba(34,197,94,0.6)]' : 'bg-red-500'"
                    :title="member.status === 'online' ? 'Available' : 'On Shoot'"
                ></div>
                ...
                <div class="flex items-center gap-4 mb-6">
                    ...
                    <div>
                        <h3 class="text-white font-bold text-lg leading-tight">{{ member.firstName }} {{ member.lastName }}</h3>
                ...
                <div class="grid grid-cols-2 gap-3 bg-black/20 p-4 rounded-lg mb-6">
                    ...
                    <div class="flex flex-col">
                        ...
                        <strong class="text-white text-sm">{{ member.rating }}</strong>
                    </div>
                </div>
